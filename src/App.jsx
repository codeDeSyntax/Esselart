  ...
  return (
    <>
     <div className='mainDiv flex flex-col h-screen bg-gradient-to-b from-[#0b0212]  to-[#0b0212]'>
        ...
        <section className='flex flex-col p-6  sm:flex-row sm:p-8  sm:gap-4 h-[80vh] '>
         
        <div className='pageText flex flex-col items-center justify-center  sm:w-[45%] gap-8 mb-10 '>
